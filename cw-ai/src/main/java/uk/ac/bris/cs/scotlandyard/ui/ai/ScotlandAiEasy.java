...
/**
 * Easy AI difficult setting for Scotland yard.
 * Uses AiCustom implementations depending on MrX or detectives
 */
public class ScotlandAiEasy implements Ai {
    AiCustom mrX = new RandomAI();
    AiCustom det = new RandomAI();
    @Nonnull
    @Override
    public String name() {
        return "Scotland Easy";
    }
